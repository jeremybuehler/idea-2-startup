      ...
      <main className="mx-auto max-w-6xl px-5 py-10 text-[15.5px] leading-7">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-700 max-w-xl text-[16px]">This interactive preview can run a simulated pipeline or trigger the Launchloom agent workflow. It drafts a PRD, wireframes, a repo scaffold, and an agent runbook—ready for export and deployment.</p>
...
(function runSelfTests(){
  ...
  if ((window as any).__LAUNCHLOOM_TESTED__) return; (window as any).__LAUNCHLOOM_TESTED__ = true;
  try {
    // toSlug tests
