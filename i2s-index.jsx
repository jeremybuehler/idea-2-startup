...
// -----------------------------
function buildGitHubNewRepoUrl(name: string, description: string, visibility: "public" | "private" = "public") {
...
async function addRepoToGitHub(slug: string, dossier: any, description: string) {
  ...
  const url = buildGitHubNewRepoUrl(slug, description || "Idea→Startup generated scaffold", "public");
      ...
      <main className="mx-auto max-w-6xl px-5 py-10 text-[15.5px] leading-7">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-700 max-w-xl text-[16px]">This interactive preview can run a simulated pipeline or trigger the Codex Agents workflow. It drafts a PRD, wireframes, a repo scaffold, and an agent runbook—ready for export and deployment.</p>
          ...
          <Card className="bg-white border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-3">
              ...
              {running && (
                <p className="text-xs text-slate-600">{useLive && apiBase ? "Orchestrating Codex agents…" : "Simulating capture → research → spec → design → scaffold…"}</p>
              )}
              {statusMsg && (
